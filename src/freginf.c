...
/* .Fortran calls */
extern void F77_NAME(datasimulation)(int *, int *, int *, int *, double *, double *, int *, double *, int *,
                                     double *, double *, int *, double *, double *, double *, double *, double *,
                                     double *, double *, double *, double *, double *);
extern void F77_NAME(datasimulationsinr)(int *, int *, int *, int *, double *, double *, int *, double *, int *,
                                         double *, double *, int *, double *, double *, double *, double *, double *,
...
static const R_FortranMethodDef FortranEntries[] = {
    {"datasimulation",      (DL_FUNC) &F77_NAME(datasimulation),        22},
    {"datasimulationsinr",  (DL_FUNC) &F77_NAME(datasimulationsinr),    25},
